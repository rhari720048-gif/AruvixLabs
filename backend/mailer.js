...
const sendWelcomeEmail = async ({ name, email, password, role }) => {
    try {
        ...
        <body>
          <div class="wrapper">
            ...
            <div class="body">
              ...
              <div class="creds-box">
                <div class="creds-row"><div class="label">Login URL</div><div class="value">https://aruvix-labs.vercel.app/login</div></div>
              ...
              <div class="btn-wrap"><a href="https://aruvix-labs.vercel.app/login" class="btn">Login to CRM →</a></div>
        ...
        console.warn('Welcome email failed/skipped:', e.message);
        return false;
    }
};
